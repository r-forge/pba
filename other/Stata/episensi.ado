...
version 8.2
syntax anything [ , UNConf(string) MIExp(string)  Format(string) STudy(string) COrder(string)  ]
...
// Missclassification of the exposure
...
if "`miexp'" != "" {
	...
	* get sensitivities and specifities of cases and non-cases
	...
	tempname seec spec seeo speo fnec fpec fneo fpeo
